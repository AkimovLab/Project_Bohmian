...
#========== Case 1 ==========
ntraj = 2000
params = {"nsteps": 400, "dt": 5.0, "print_period":40,
          "ham": Martens_model2,  "ham_params": {"Va": 0.00625, "Vb": 0.0106, "Vc":0.0 },
          "do_bohmian": 0,  "tbf_type":None, "qpot_sigmas": torch.tensor([ [0.5, 0.5]] * ntraj)
         }


prefix = "classical-MartensI-case1-1"
...
#========== Case 3 ==========
prefix = "classical-MartensII-case1-1"
prms = dict(params); prms.update({"prefix":prefix, "ham_params": {"Va": 0.00625, "Vb": 0.0106, "Vc":0.4 }})
q, p, masses = compute.init_variables(ntraj, 1)
compute.md(q, p, masses, prms)
plot.plot({ "filename":F"{prefix}.pt", "prefix":prefix, "do_show":False, "which_timesteps":[0, 100, 200, 300, 399] })

#========== Case 4 ==========
prefix = "classical-MartensII-case2-1"
prms = dict(params); prms.update({"prefix":prefix, "ham_params": {"Va": 0.00625, "Vb": 0.0106, "Vc":0.4 }} )
q, p, masses = compute.init_variables(ntraj, 2)
compute.md(q, p, masses, prms)
plot.plot({ "filename":F"{prefix}.pt", "prefix":prefix, "do_show":False, "which_timesteps":[0, 100, 200, 300, 399] })
