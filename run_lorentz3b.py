...
#========== Case 1 ==========
ntraj = 500
params = {"nsteps": 800, "dt": 2.5, "print_period":8,
          "ham": Martens_model2,  "ham_params": {"Va": 0.00625, "Vb": 0.0106, "Vc":0.0 },
          "do_bohmian": 1,  "tbf_type":compute.rho_lorentzian, "qpot_sigmas": torch.tensor([ [0.05, 0.05]] * ntraj)
         }


prefix = "bohmian-lorentzian-MartensI-case1-3b"
...
prefix = "bohmian-lorentzian-MartensI-case2-3b"
prms = dict(params); prms.update({"prefix":prefix})
...
prefix = "bohmian-lorentzian-MartensII-case1-3b"
prms = dict(params); prms.update({"prefix":prefix})
q, p, masses = compute.init_variables(ntraj, 1)
compute.md(q, p, masses, prms)
plot.plot({ "filename":F"{prefix}.pt", "prefix":prefix, "do_show":False, "which_timesteps":[0, 100, 200, 300, 399] })
...
prefix = "bohmian-lorentzian-MartensII-case2-3b"
prms = dict(params); prms.update({"prefix":prefix})
q, p, masses = compute.init_variables(ntraj, 2)
compute.md(q, p, masses, prms)
plot.plot({ "filename":F"{prefix}.pt", "prefix":prefix, "do_show":False, "which_timesteps":[0, 100, 200, 300, 399] })
